...
| `codex-delegate` | Delegate implementation, investigation, or bulk work to the gpt-5.6 codex family via direct pinned `codex exec` (Model Routing v4 lanes: Sol-high implementation default, delegation gate, no Claude shims). | [skills/codex-delegate/SKILL.md](skills/codex-delegate/SKILL.md) |
