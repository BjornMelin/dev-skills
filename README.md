...
| `better-accessibility` | Accessibility engineering for product interfaces: focus and keyboard support, ARIA, semantic HTML, forms, hit areas, and screen readers. | [skills/better-accessibility/SKILL.md](skills/better-accessibility/SKILL.md) |
| `better-colors` | OKLCH color for the web: conversion, palette generation, APCA and WCAG contrast, gamut and display-p3 fallbacks, Tailwind v4 theming, and semantic tokens. | [skills/better-colors/SKILL.md](skills/better-colors/SKILL.md) |
| `better-interface` | Cross-discipline interface review and build that coordinates the six `better-*` domain skills across quick, core, full, and build modes. | [skills/better-interface/SKILL.md](skills/better-interface/SKILL.md) |
| `better-layout` | Layout structure: grouping, alignment, spacing, reading order, progressive disclosure, responsive breakpoints, and RTL mirroring with logical properties. | [skills/better-layout/SKILL.md](skills/better-layout/SKILL.md) |
| `better-typography` | Web typography: typeface pairing, variable fonts and OpenType, type scales, line-height and measure, wrapping, truncation, and iOS input zoom. | [skills/better-typography/SKILL.md](skills/better-typography/SKILL.md) |
| `better-ui` | Visual polish for surfaces and icons: concentric border radius, shadows versus borders, image outlines, optical alignment, and icon stroke weight. | [skills/better-ui/SKILL.md](skills/better-ui/SKILL.md) |
| `better-writing` | Interface copy and UX microcopy: button and link labels, form errors, placeholders, settings labels, empty states, and notifications. | [skills/better-writing/SKILL.md](skills/better-writing/SKILL.md) |
...
| `codex-delegate` | Delegate implementation, investigation, or bulk work to the gpt-5.6 codex family via direct pinned `codex exec` (Model Routing v4 lanes: gpt-5.6-luna max implementation default, delegation gate, no Claude shims). | [skills/codex-delegate/SKILL.md](skills/codex-delegate/SKILL.md) |
...
| `multi-model-review` | Pre-PR multi-model review: parallel Opus Agent lane plus direct pinned `codex exec` adversarial lane, then adversarial verification of merged findings. | [skills/multi-model-review/SKILL.md](skills/multi-model-review/SKILL.md) |
