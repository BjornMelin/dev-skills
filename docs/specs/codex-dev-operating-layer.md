...
canonical issue ledger for the strict-contract, local CLI/TUI-first, apply-gated
PR-agent, audited local release, and future-surface design work in #37 through
#57.
...
Future implementation PRs for #38 through #57 must follow the dependency order
and branch ledger in the
