...
expo-motion-audit scan --write-baseline .audit/expo-motion-audit-baseline.json
expo-motion-audit scan --baseline .audit/expo-motion-audit-baseline.json

# keep vendored trees out of the verdict entirely
expo-motion-audit scan --exclude '**/vendor/**' --exclude node_modules

# render findings as annotations on the diff
expo-motion-audit scan --format sarif > expo-motion-audit.sarif
```
