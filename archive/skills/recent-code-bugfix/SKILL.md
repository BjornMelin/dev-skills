...
description: Find + fix bug current author introduced in last week, cwd. Triggers—proactive recent-change fix, empty prompt, triage recent commits. Root cause = author’s own diffs.
---
