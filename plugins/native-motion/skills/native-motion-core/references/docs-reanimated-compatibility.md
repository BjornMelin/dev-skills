[Skip to main content](https://docs.swmansion.com/react-native-reanimated/docs/guides/compatibility/#__docusaurus_skipToContent_fallback)
...
- [4.x](https://docs.swmansion.com/react-native-reanimated/docs/guides/compatibility)
- [3.x](https://docs.swmansion.com/react-native-reanimated/docs/3.x/guides/compatibility)
...
### Supported React Native versions [​](https://docs.swmansion.com/react-native-reanimated/docs/guides/compatibility/\#supported-react-native-versions "Direct link to Supported React Native versions")

|  | 0.78 | 0.79 | 0.80 | 0.81 | 0.82 | 0.83 | 0.84 | 0.85 | 0.86 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nightly | no | no | no | no | no | yes | yes | yes | yes |
| 4.5.x | no | no | no | no | no | yes | yes | yes | yes |
| 4.4.x | no | no | no | no | no | yes | yes | yes | yes |
| 4.3.x | no | no | no | yes | yes | yes | yes | yes | no |
| 4.2.x | no | no | yes | yes | yes | yes | yes | no | no |
| 4.1.x | yes | yes | yes | yes | yes | no | no | no | no |
| 4.0.x | yes | yes | yes | yes | no | no | no | no | no |

### Supported react-native-worklets versions [​](https://docs.swmansion.com/react-native-reanimated/docs/guides/compatibility/\#supported-react-native-worklets-versions "Direct link to Supported react-native-worklets versions")
...
|  | 0.4.x | 0.5.x | 0.6.x | 0.7.x | 0.8.x | 0.9.x | 0.10.x | nightly |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nightly | no | no | no | no | no | no | no | yes |
| 4.5.x | no | no | no | no | no | no | yes | no |
| 4.4.x | no | no | no | no | no | yes | no | no |
| 4.3.x | no | no | no | no | yes | no | no | no |
| 4.2.x | no | no | no | yes | yes | no | no | no |
| 4.1.x | no | yes | yes | yes | yes | no | no | no |
| 4.0.x | yes | no | no | no | no | no | no | no |

[Edit this page](https://github.com/software-mansion/react-native-reanimated/edit/main/docs/docs-reanimated/docs/guides/compatibility.mdx)
...
Previous\\
\\
Building for Android on Windows](https://docs.swmansion.com/react-native-reanimated/docs/guides/building-on-windows) [![](data:image/svg+xml,%3csvg%20width='13'%20height='10'%20viewBox='0%200%2013%2010'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M11.6865%205H1.68652'%20stroke='%23001A72'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M7.68652%209L11.6865%205L7.68652%201'%20stroke='%23001A72'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e)\\
\\
Next\\
\\
Contributing](https://docs.swmansion.com/react-native-reanimated/docs/guides/contributing)

- [Supported React Native versions](https://docs.swmansion.com/react-native-reanimated/docs/guides/compatibility/#supported-react-native-versions)
- [Supported react-native-worklets versions](https://docs.swmansion.com/react-native-reanimated/docs/guides/compatibility/#supported-react-native-worklets-versions)
