...
3. Use Codex-native web tools for official/current checks.
4. Use provider commands only when the route plan calls for them.
5. Add source and claim records to `.codex/research/ledger.jsonl`.
6. Render `codex-research report`.
